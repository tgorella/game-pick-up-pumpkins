...
<body>
	<audio
	 autoplay="true" 
        src="./src/halloween_2018_02 - Halloween Theme.mp3">
    </audio>
	<section id="welcome">
		<img src="./src/welcome-img.webp">
<h1>Welcome to<br>Pick Up Pumpkin</h1>
...
<button class="play-btn" id="start-play-btn">Играть</button>
	</section>
	<section id="game">
</section>
...
welcomeImg.src = './src/welcome-img.webp';
welcomeImg.alt = 'Pick Up Pumpkins';
const welcomeHeader = document.createElement('h1');
welcomeHeader.innerHTML=`Welcome to<br>Pick Up Pumpkin`;
